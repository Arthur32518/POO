...
namespace AulaClasse
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //metodosSenai.MarcaDoProduto = Console.ReadLine();
            //Console.WriteLine("Codigo do produto: ");
            //metodosSenai.CodigoProduto = Console.ReadLine();
            //Console.WriteLine("Digite a quantidade: ");
            //metodosSenai.quantidade = Convert.ToInt32(Console.ReadLine());
            //metodosSenai.Produtos();
